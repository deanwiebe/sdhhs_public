...
<div class="generic-content">
    <div class="row">
        <img src="<?php the_post_thumbnail_url('front-page-cards') ?>" alt="" srcset="">
    </div>
    <div class="row row-content">
        ...
        <h1><?php the_title() ?></h1>
            ...
            <?php the_content() ?>
            <a href="<?php echo site_url('/staff') ?>"><span>Back to Staff</span><i class="fas fa-long-arrow-alt-right"></i></a>
        </div>
    </div>
</div>
<?php }
